...
const Rutina_Hombro_ = ({ navigation }) => {
        ...
        <SafeAreaView style={styles.Container}>
            <View style={{ flex: 1, marginTop: 50, flexDirection: 'row' }}>
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => { navigation.navigate('ContainerFragment') }}>
                        <Ionicons name="arrow-back" size={30} color="black" />
                    </TouchableOpacity>
                </View>
                <View style={{ flex: 3 }}>
                    <Text style={{ fontSize: 35, textAlign: 'center' }}> HOMBRO</Text>
                </View>
                <View style={{ flex: 1 }}>
                </View>
            </View>
